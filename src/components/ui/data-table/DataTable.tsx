...
import { DataTableBulkEditor, BulkEditorAction } from "./DataTableBulkEditor"
...
import type { FilterType } from "./../utils/tables/generateFilters"
...
export interface DataTableProps<TData extends Record<string, any>> {
  ...
  customFilters?: Partial<
    ...
    >
  >
  bulkActions?: BulkEditorAction<TData>[]
}
